...
We will explore trends in biodiversity loss among various species over time and explain possible causes for the phenomenons we witness in the data.

By Kristin Liu and Briana Huynh
...
Question 1: We hope to replicate results of the existing study that was done in the research paper.
Question 2: We hope to create our own graphs to compare trends between different species.
Question 3: How is biodiversity measured? What are possible causes of biodiversity loss and how do they relate to the trends in the graphs we created? What are the future effects of the loss of species diversity?
